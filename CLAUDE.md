...
| 8 | LLM-as-judge reward (Bedrock + gpt-oss), on top of Phase 7 (build + smoke test) | `docs/phase-8-llm-judge.md` | Not started — **blocked on 7d**. The judge is the paper's separate Appendix C.2/C.3 exploration; building it on top of an incomplete Table 2 reproduction compounds the gap rather than adding to it |
